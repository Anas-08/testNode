    ...
    <center>    
        ...
        <form action="" method="post">
            <table>
                ...
                <tr>
                    <td> </td>
                    <td> Already Register ? <a href="./login.php"> login here</a> </td>
                </tr>  
...
<?php 
    if(isset($_POST['register'])) {
        ...
        $query = "insert into register1(name, email, password, mobile, dob, address, gender, course, hobbies) values('$name','$email',
        '$password','$mobile','$date','$address','$gender','$course','$hobb1') ";
